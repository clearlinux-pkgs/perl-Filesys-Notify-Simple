...
cp %{_builddir}/Filesys-Notify-Simple-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Filesys-Notify-Simple/6eee64e6240eb3496293e0e3a8d568e984e4f1fa || :
if test -f Makefile.PL; then
