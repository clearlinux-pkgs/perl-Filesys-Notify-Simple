...
Requires: perl-Filesys-Notify-Simple-license
Requires: perl-Filesys-Notify-Simple-man
...
%package man
Summary: man components for the perl-Filesys-Notify-Simple package.
Group: Default

%description man
man components for the perl-Filesys-Notify-Simple package.
...
mkdir -p %{_topdir}/BUILD/Filesys-Notify-Simple-0.13/deblicense/
...
%install
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/perl-Filesys-Notify-Simple
cp LICENSE %{buildroot}/usr/share/doc/perl-Filesys-Notify-Simple/LICENSE
cp deblicense/copyright %{buildroot}/usr/share/doc/perl-Filesys-Notify-Simple/deblicense_copyright
if test -f Makefile.PL; then
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/Filesys/Notify/Simple.pm

%files license
%defattr(-,root,root,-)
/usr/share/doc/perl-Filesys-Notify-Simple/LICENSE
/usr/share/doc/perl-Filesys-Notify-Simple/deblicense_copyright
